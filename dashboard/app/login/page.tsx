    ...
    <div style={{
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <div style={{
          ...
          fontFamily: "'Space Grotesk', sans-serif", fontWeight: 800, fontSize: 20, color: "#fff",
        }}>
          C
        </div>
        <h1 style={{
          fontFamily: "'Space Grotesk', sans-serif", fontSize: 18, margin: "0 0 4px",
        ...
        <p style={{ fontSize: 12, color: "var(--text-faint)", margin: "0 0 24px" }}>
          Private preview · Tribal Music Group
        </p>
        ...
        <button
          ...
          style={{
            ...
            fontFamily: "'Space Grotesk', sans-serif", opacity: loading || !password ? 0.6 : 1,
          }}
        >
